...
Установщик запросит личные API key и API secret LMS, подключит активные скиллы, установит карту обращений в память Codex и зарегистрирует ежедневное обновление.
...
5. Карта обращений в `~/.codex/paper-planes-skill-routing.md` пересобирается из актуального реестра.
